...
export default function CarbonFootprintGraphs({ history }: GraphProps) {
    ...
    const processedData = useMemo(() => {
        ...
        const monthlyData = sortedHistory.reduce((acc: Array<{ month: string; total: number; count: number; average: number }>, entry) => {
        ...
        const transportData = history.reduce((acc: Array<{ mode: string; total: number; count: number; average: number }>, entry) => {
